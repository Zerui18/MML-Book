...
\subquestion{a}
Prove that $\pi$ is a projection if and only if $\id_V - \pi$ is a projection, where $\id_V$ is the identity endomorhism of $V$.

\begin{align*}
	(\id_V - \pi)^2 &= \id_V - \pi \tag{ $\id_V - \pi$ is a projection } \\
	\id_V - 2\pi + \pi^2 &= \id_V - \pi \\
	\pi^2 &= \pi \tag{ $\pi$ is a projection }
\end{align*}
\qed
